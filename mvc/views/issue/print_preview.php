  ...
  <body>
    <div id="page-wrap">
      ...
      <table class="table table-bordered">
        <thead>
          <tr>
              <th width="15"><?=$this->lang->line('slno')?></th>
              <th width="15"><?=$this->lang->line('issue_lid')?></th>
              <th width="20"><?=$this->lang->line('issue_book')?></th>
              <th width="15"><?=$this->lang->line('issue_due_date')?></th>
              <th width="15"><?=$this->lang->line('issue_return_date')?></th>
              <th width="20"><?=$this->lang->line('issue_fine')?></th>
          </tr>
        </thead>
      ...
      <table width="100%">
        <tr>
          ...
          <td class="td-style" width="14%">
            <?=$this->lang->line('issue_total')." " .$total_fine?>
          </td>
        </tr>
      </table>
