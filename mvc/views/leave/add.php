...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-bell"></i> <?=$this->lang->line('panel_title')?></h3>


        <ol class="breadcrumb">
            <li><a href="<?=base_url("dashboard/index")?>"><i class="fa fa-laptop"></i> <?=$this->lang->line('menu_dashboard')?></a></li>
            <li><a href="<?=base_url("leave/index")?>"><?=$this->lang->line('menu_leave')?></a></li>
            <li class="active"><?=$this->lang->line('leave_add_leave')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
            ...
            <div class="col-sm-12">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("to", $array, set_value("to"), "id='to' class='form-control'");
                            ?>
                        </div>
                    </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" id="leave" name="details" ><?=set_value('details')?></textarea>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("leave_submit")?>" >
                        </div>
                    </div>
